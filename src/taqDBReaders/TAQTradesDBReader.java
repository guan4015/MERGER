...
//	@Override
//	public void FileGeneration( long sequencenumber, int ID ) throws IOException {
//		
...
//		
//		// Specify the directory, needs to be implemented
//		String directory = "";
//		
//		// Initialize the stock ID
//		Integer StockId = ID;
//		// Specify the filename
//		String filename = directory + sequenceNumberStr + "_" + StockId.toString() + "_1.dat";
//		
//		// Create writers
//		FileWriter writer = new FileWriter( filename );
//		BufferedWriter bufferwriter = new BufferedWriter( writer );
//		Integer numRec = _nRecsRead;
//		
//		String numRecStr = numRec.toString();
//		
//		bufferwriter.write( numRecStr );
//		bufferwriter.newLine();
//		
//		for (int i = 0 ; i < _nRecsRead; i++){
//			int StockID = ID;
//			Long sequence = getSequenceNum( i );
//			int size = getSize( i );
//			Float price = getPrice( i );
//			// Convert the stock record
//			// sequence number // stock ID // size // price
//			String record = sequence + "," + StockID + "," 
//			                + size + "," + price;
